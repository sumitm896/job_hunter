...
def run_detection(targets_path: str, write_back: bool = False,
                  apply_location_filter: bool = True) -> tuple[list[dict], list[dict]]:
    """
